...
public class CircleManager : MonoBehaviour
{
   ...
   /* [ContextMenu(nameof(CreateCirclesFromPieces))]
    ...
    [ContextMenu(nameof(CreateCirclesFromPrefab))]

    public void CreateCirclesFromPrefab()
    {
        CreateCirclesPrefab(createAmount);
    }
    ...
    /// </summary>
    /// <param name="createAmount"></param>
    public void CreateCirclesPrefab(int createAmount)
    {
